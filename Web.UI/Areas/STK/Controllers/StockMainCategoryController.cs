...
namespace Web.UI.Areas.STK.Controllers
{
    [JsonAllowGet]
    [MinifyHtml]
    public class StockMainCategoryController : XGenericController<StockMainCategory, StockMainCategoryInput, StockMainCategoryInput>
    {
        public StockMainCategoryController(IRepo<StockMainCategory> repo, IMapper mapper)
            : base(repo, mapper)
        {

        }
        protected override object MapEntityToGridModel(StockMainCategory model)
        {
