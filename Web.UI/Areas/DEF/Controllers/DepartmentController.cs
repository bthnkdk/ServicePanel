...
namespace Web.UI.Areas.DEF.Controllers
{
    [JsonAllowGet]
    [MinifyHtml]
    public class DepartmentController : XGenericController<Department, DepartmentInput, DepartmentInput>
    {
        public DepartmentController(IRepo<Department> repo, IMapper mapper)
            : base(repo, mapper)
        {

        }
        protected override object MapEntityToGridModel(Department model)
        {
            return new { model.Id, model.Name, model.Code, model.IsDeleted };
        }
