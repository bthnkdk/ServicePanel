...
namespace Web.UI.Areas.DEF.Controllers
{
    [JsonAllowGet]
    [MinifyHtml]
    public class VisitCategoryController : XGenericController<VisitCategory, VisitCategoryInput, VisitCategoryInput>
    {
        public VisitCategoryController(IRepo<VisitCategory> repo, IMapper mapper)
            : base(repo, mapper)
        {

        }
        protected override object MapEntityToGridModel(VisitCategory model)
        {
