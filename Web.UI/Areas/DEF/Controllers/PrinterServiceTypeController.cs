...
namespace Web.UI.Areas.DEF.Controllers
{
    [JsonAllowGet]
    [MinifyHtml]
    public class PrinterServiceTypeController : XGenericController<PrinterServiceType, PrinterServiceTypeInput, PrinterServiceTypeInput>
    {
        public PrinterServiceTypeController(IRepo<PrinterServiceType> repo, IMapper mapper)
            : base(repo, mapper)
        {

        }
        protected override object MapEntityToGridModel(PrinterServiceType model)
        {
