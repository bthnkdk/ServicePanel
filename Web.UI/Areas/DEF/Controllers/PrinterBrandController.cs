...
namespace Web.UI.Areas.DEF.Controllers
{
    [JsonAllowGet]
    [MinifyHtml]
    public class PrinterBrandController : GenericController<PrinterBrand, PrinterBrandInput, PrinterBrandInput>
    {
        public PrinterBrandController(IRepo<PrinterBrand> repo, IMapper mapper)
            : base(repo, mapper)
        {

        }
        protected override object MapEntityToGridModel(PrinterBrand model)
        {
