...
namespace Web.UI.Areas.SYS.Controllers
{
    [JsonAllowGet]
    [MinifyHtml]
    public class AreaController : XGenericController<Area, AreaInput, AreaInput>
    {
        public AreaController(IRepo<Area> repo, IMapper mapper)
            : base(repo, mapper)
        {

        }
        protected override object MapEntityToGridModel(Area model)
        {
